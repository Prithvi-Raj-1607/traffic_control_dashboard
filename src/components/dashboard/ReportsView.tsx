...
import { Download, FileText, FileSpreadsheet, Brain, BarChart3 } from 'lucide-react';

export default function ReportsView() {
  const reports = [
    { title: 'Download CSV Data', description: 'Complete traffic violation dataset with all fields and records', icon: FileSpreadsheet, color: '#66B800', bgColor: 'bg-[#66B800]/10', action: 'Download CSV' },
    { title: 'Association Rules Report', description: 'Apriori algorithm results with support, confidence, and lift metrics', icon: Brain, color: '#3B82F6', bgColor: 'bg-blue-50', action: 'Download Rules' },
    { title: 'Cluster Analysis Report', description: 'K-Means clustering results with risk zone classification', icon: BarChart3, color: '#F59E0B', bgColor: 'bg-yellow-50', action: 'Download Clusters' },
    { title: 'Summary Report', description: 'Complete DWDM project report with methodology and findings', icon: FileText, color: '#8B5CF6', bgColor: 'bg-purple-50', action: 'Download Report' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        <div className="flex items-center gap-2 mb-4"><FileText className="w-5 h-5 text-[#66B800]" /><h3 className="text-sm font-bold text-gray-900">DWDM Project Report &mdash; Content Preview</h3></div>
